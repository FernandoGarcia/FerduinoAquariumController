...
// If all is right place this values at URtouchCD.h
...
//
//URTouch      myTouch(6,5,4,3, 2); // For TFT shield
URTouch      myTouch(7,6,5,4,3); // For Ferduino Mega 2560
...
void setup()
{
  ...
  Serial.println(F("If all is right place this values at URtouchCD.h"));
  myGLCD.InitLCD();
  myGLCD.clrScr();
