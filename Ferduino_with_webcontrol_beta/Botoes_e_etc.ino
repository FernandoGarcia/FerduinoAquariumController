...
const int iniC[]= {
  325, 2, 390, 42};           // inicio
const int menU[]= {
  325, 52, 390, 92};       // Botao menu
const int prOK[]= {
  325, 200, 390, 238};        //ok
const int salV[]= {
  325, 150, 390, 190};        //salvar dosagem
const int deS[]= {
  325, 102, 390, 142};
...
const int tempeC[]= {
  265, 35, 290, 60};      //Temperatura reduzir potência +
const int tempeB[]= {
  265, 70, 290, 95};      //Temperatura reduzir potência -
const int potC[]= {
  265, 115, 290, 140};      //Reduzir potência + 
const int potB[]= {
  265, 150, 290, 175};      //Reduzir potência - 
const byte peRB[]= {
  45, 145, 70, 170};
const byte peRC[]= {
  160, 145, 185, 170}; 
